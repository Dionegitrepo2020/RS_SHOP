...
namespace RS_SHOP_Dev.CustomRenderers
{
    public class DatePickerEntry : DatePicker
    {
        ...
        //Gets and Sets Placeholder
        public static readonly BindableProperty EnterTextProperty = 
            BindableProperty.Create(propertyName: "Placeholder", returnType: typeof(string), declaringType: typeof(DatePickerEntry), defaultValue: default(string));
